...
namespace Unrez.BackyardShowdown
{
    public class Prey : Pawn
    {
        ...
        {
            _pawnHealth.TakeDamage(damage);
        }

        public override void TryAbility(int idxAbility)
        {
            if (_pawnAbilities.CanUseAbility(idxAbility))
            {
                _pawnAbilities.ExecuteAbility(idxAbility);
            }
        }
